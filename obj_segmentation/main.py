...
confThreshold = 0.5  # Limiar de confiança
nmsThreshold = 0.4  
...
while True:
    ...
    #start e end é para calcular o fps
    start = time.time()
    classes, scores, boxes = model.detect (frame,0.01,0.02) #mudar o pesos para melhorar a rede 
    end =time.time()
...
cap.release()
cv2.destroyAllWindows()
>>>>>>> 76ca276fe0e77d9408012d5df49c96fbbb7de11d
>>>>>>> 1d15eef (Projeto finalizado)
